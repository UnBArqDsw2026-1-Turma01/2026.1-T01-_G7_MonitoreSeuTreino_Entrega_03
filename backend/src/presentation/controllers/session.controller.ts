...
export class SessionController {
  constructor(private readonly registerSessionUseCase: RegisterSessionUseCase) {}

  @Post()
  @UseGuards(BearerTokenGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Registra a execução de uma nova Sessão de Treino' })
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Sessão registrada com sucesso.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Dados inválidos no payload.' })
