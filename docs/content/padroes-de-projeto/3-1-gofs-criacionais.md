...
**Entrega Mínima:** 1 Padrão GoF Criacional, com nível de modelagem e nível de implementação evidenciados (código rodando e hospedado no repositório do projeto).

**Apresentação** (via vídeo enviado por e-mail) explicando o GoF Criacional, com: (i) rastro claro aos membros participantes (MOSTRAR QUADRO DE PARTICIPAÇÕES & COMMITS); (ii) justificativas & senso crítico sobre o padrão GoF criacional; e (iii) comentários gerais sobre o trabalho em equipe. Tempo: +/- 5min.
